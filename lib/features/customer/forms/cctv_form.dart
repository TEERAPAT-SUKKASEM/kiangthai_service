...
class CctvForm extends StatefulWidget {
  const CctvForm({super.key});

  @override
  State<CctvForm> createState() => _CctvFormState();
}

class _CctvFormState extends State<CctvForm> {
  // --- 🧠 ตัวแปรเฉพาะของงาน CCTV ---
  String _serviceType = 'Installation';
  String _cameraType = 'Not Sure';
  int _cameraCount = 4; // ค่าเริ่มต้นที่ 4 ตัว (เซ็ตมาตรฐานของกล้องวงจรปิด)
  ...
  final List<String> _bookedTimeSlots = [
    ...
    '14:30',
    '15:00',
  ]; // สุ่มคิวเต็มของช่าง CCTV
  final DateTime _fullyBookedDate = DateTime.now().add(const Duration(days: 5));
  ...
  void _submitBooking() {
    ...
    print("--- CCTV BOOKING DATA ---");
    print(
      "Service: $_serviceType | System: $_cameraType | Cameras: $_cameraCount units",
    );
    print(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('CCTV Booking Ready to Save!')),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () => setState(() {
                                    if (_cameraCount > 1) _cameraCount--;
                                  }),
                                  child: const Icon(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                            'Provide details (e.g. NVR issue, blind spots to cover)...',
                        filled: true,
                        fillColor: Colors.white,
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(15),
                    ...
                    Text(
                      'Provide photos of the installation area or existing DVR/NVR box.',
                      style: TextStyle(
                        fontSize: 13,
