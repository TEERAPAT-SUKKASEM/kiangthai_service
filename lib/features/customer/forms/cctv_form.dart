...
class _CctvFormState extends State<CctvForm> {
  ...
  final List<String> _bookedTimeSlots = ['14:00', '14:30', '15:00'];
  ...
  Future<void> _submitBooking() async {
    ...
    try {
      ...
      for (File image in _selectedImages) {
        ...
        final filePath = 'cctv/$fileName'; // 📂 โฟลเดอร์ cctv
      ...
      // 📦 แพ็คข้อมูลเฉพาะของงานกล้อง
      final specificDetails = {
        'camera_type': _cameraType,
        'camera_count': _cameraCount,
      };
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('CCTV Booking Successful! 🎉')),
      );
